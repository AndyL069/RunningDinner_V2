...
namespace RunningDinner.Data.Migrations
{
    ...
    [Migration("20200209201803_TeamChanges")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RunningDinner.Models.DatabaseModels.DinnerHost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RunningDinner.Models.DatabaseModels.Route", b =>
                {
                    ...
                    b.HasOne("RunningDinner.Models.DatabaseModels.DinnerHost", "FirstCourse")
                        .WithMany()
                        .HasForeignKey("FirstCourseId");

                    b.HasOne("RunningDinner.Models.DatabaseModels.DinnerHost", "SecondCourse")
                        .WithMany()
                        .HasForeignKey("SecondCourseId");

                    b.HasOne("RunningDinner.Models.DatabaseModels.DinnerHost", "ThirdCourse")
                        .WithMany()
                        .HasForeignKey("ThirdCourseId");
                });
