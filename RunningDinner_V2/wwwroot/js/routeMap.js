function createRouteMap(mapCenterLat, mapCenterLong, kitchen, routes, party, apiKey) {
...
function addPolylineToMap(map, coordinates) {
    // Polyline
    let coordinatesArray0 = coordinates[0].split(';');
    let coordinatesArray1 = coordinates[1].split(';');
    let coordinatesArray2 = coordinates[2].split(';');
